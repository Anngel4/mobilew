...
const options = [
    {
        title:'Posição Atual',
        description:'Consulte a localização utilizando o GPS',
        route:'PosicaoGPSScreen'
    },
     
     {
        title:'Redes Wifi',
        description:'Consulte todas as redes wifi',
        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                <View style={styles.heading}>
                    <Text style={styles.eyebrow}>RECURSOS DO DISPOSITIVO</Text>
                    <Text style={styles.title}>Escolha uma ferramenta</Text>
                    <Text style={styles.subtitle}>Explore os sensores e informações do seu dispositivo</Text>
                </View>
